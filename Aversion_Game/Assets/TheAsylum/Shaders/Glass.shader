...
Shader "Specular/Glass" {
    Properties {
        ...
        _BumpMapTile ("BumpMap Tile", Float ) = 1
...
/////// Vectors:
                ...
                float2 node_728 = (i.uv0*_BumpMapTile);
                float3 _BumpMap_var = UnpackNormal(tex2D(_BumpMap,TRANSFORM_TEX(node_728, _BumpMap)));
...
/// Final Color:
                ...
                return fixed4(finalColor,lerp( pow((_TransparencyLM_var.r*_TransparencyLM_Amound),_TransparencyLM_Power), _FullTransparency_Amound, _FullTransparency ));
            }
            ENDCG
        }
        Pass {
